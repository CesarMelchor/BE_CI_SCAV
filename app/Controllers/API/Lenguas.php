...
use App\Models\LenguasModel;
use CodeIgniter\RESTful\ResourceController;

class Lenguas extends ResourceController{

    public function __construct(){
        $this->model = new LenguasModel();
    }

    public function getAll()
    {

       $lenguas = $this->model->findAll();

        return $this->respond($lenguas);
    }



    public function obtenerLenguasExcel(){

        $rutaArchivo = WRITEPATH.'/assets/excel/lenguas_indigenas.csv';
